"""Init with users and multi-tenancy

Revision ID: d28bc5152e54
Revises: 
Create Date: 2026-05-03 12:12:40.057443
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_budget_allocations_category'), 'budget_allocations', ['category'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_budget_allocations_category'), table_name='budget_allocations')
